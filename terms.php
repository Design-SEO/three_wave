    ...
    <section class="terms">
        <div class="container">
            <h2 class="title contact-title">
                <?php echo getLang('terms_title') ?>
            </h2>

            <div class="terms-content">
                <p><?php echo getLang('terms_updated') ?></p>

                <h3><?php echo getLang('terms_1_title') ?></h3>
                <?php echo getLang('terms_1_text') ?>

                <h3><?php echo getLang('terms_2_title') ?></h3>
                <?php echo getLang('terms_2_text') ?>

                <h3><?php echo getLang('terms_3_title') ?></h3>
                <?php echo getLang('terms_3_text') ?>

                <h3><?php echo getLang('terms_4_title') ?></h3>
                <?php echo getLang('terms_4_text') ?>

                <h3><?php echo getLang('terms_5_title') ?></h3>
                <?php echo getLang('terms_5_text') ?>

                <h3><?php echo getLang('terms_6_title') ?></h3>
                <?php echo getLang('terms_6_text') ?>

                <h3><?php echo getLang('terms_7_title') ?></h3>
                <?php echo getLang('terms_7_text') ?>

                <h3><?php echo getLang('terms_8_title') ?></h3>
                <?php echo getLang('terms_8_text') ?>

                <h3><?php echo getLang('terms_9_title') ?></h3>
                <?php echo getLang('terms_9_text') ?>

                <h3><?php echo getLang('terms_10_title') ?></h3>
                <?php echo getLang('terms_10_text') ?>

                <h3><?php echo getLang('terms_11_title') ?></h3>
                <?php echo getLang('terms_11_text') ?>

                <h3><?php echo getLang('terms_12_title') ?></h3>
                <?php echo getLang('terms_12_text') ?>

                <h3><?php echo getLang('terms_13_title') ?></h3>
                <?php echo getLang('terms_13_text') ?>

                <h3><?php echo getLang('terms_14_title') ?></h3>
                <?php echo getLang('terms_14_text') ?>

                <h3><?php echo getLang('terms_15_title') ?></h3>
                <?php echo getLang('terms_15_text') ?>

                <h3><?php echo getLang('terms_16_title') ?></h3>
                <?php echo getLang('terms_16_text') ?>
            </div>
        </div>
    </section>
</main>
